  ...
  return (
    <ThemeProvider attribute={"class"} defaultTheme={"system"} enableSystem>
      ...
      <Container>
        ...
        <br />
        <p>
          Ce site à pour seul but de regrouper toutes tes notes dans un seul et
          même endroit, il te permet aussi de calculer automatiquement tes
        ...
        <p>
          ...
          n'hésites surtout pas à venir me voir en pv Insta, je suis ouvert à la
          discussion.
        </p>
        <br />
        <p>
